...
interface LocalForageDbMethodsCore {
    ...
    getMultipleItems<T>(keys: ReadonlyArray<keyof T>, synchronizationKey: string): Promise<Readonly<{values: T, synchronizationValue?: string}>>;

    setItem<T>(key: string, value: T, callback?: (err: any, value: T) => void): Promise<T>;

    setMultipleItems(input: Readonly<{[key: string]: unknown}>, synchronizationKey: string, expectedSynchronizationValue?: string, newSynchronizationValue: string, forceWrite: boolean): Promise<void>;
